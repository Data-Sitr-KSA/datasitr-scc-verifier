...
exporter_status := "PASS" if exporter_window_ok

exporter_status := "FAIL" if not exporter_window_ok
...
sdaia_status := "PASS" if sdaia_window_ok

sdaia_status := "FAIL" if not sdaia_window_ok
